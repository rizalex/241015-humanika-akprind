...
<section>
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li class="menu-list  nav-active"><a href="#"><i class="fa fa-credit-card"></i> <span>Verifikasi Administrasi</span></a>
					<ul class="sub-menu-list">
						...
						<li><a href="peserta_verifikasi_berkas.php">Verifikasi Status Peserta</a></li>
					</ul>
				</li>
    ...
    <div class="main-content" >
        ...
        <div class="panel-body">
				<a class="btn btn-danger" href="peserta_verifikasi_berkas.php?hal=kegiatan&keg=LDKM"> LDKM</a>
				<a class="btn btn-success" href="peserta_verifikasi_berkas.php?hal=kegiatan&keg=SE"> SE</a>
			<div class="adv-table">
				<table  class="display table table-bordered table-striped" id="dynamic-table">
					...
					<tbody>
						...
						echo "
							...
							<td class='center hidden-phone'>"; if($data->status_berkas=='Unvalid'){ echo "<a href='peserta_verifikasi_berkas_detail.php?id=$data->id_peserta'><button class='btn btn-info' type='button'> Unvalid</button></a>";}
							else {echo "<button class='btn btn-info' type='button' disabled> Valid</button>";}
							echo "</td> 								
						</tr>";
						}?>
					</tbody>
        ...
        <div class="panel-body">
			<div class="btn-group">
				...
				<ul role="menu" class="dropdown-menu">
					<li><a href="peserta_verifikasi_berkas.php?hal=pertahun&keg=<?php echo $keg?>&tahun=2015">2015</a></li>
					<li><a href="peserta_verifikasi_berkas.php?hal=pertahun&keg=<?php echo $keg?>&tahun=2016">2016</a></li>
					<li><a href="peserta_verifikasi_berkas.php?hal=pertahun&keg=<?php echo $keg?>&tahun=2017">2017</a></li>
				</ul>
			</div>
				<a class="btn btn-danger" href="peserta_verifikasi_berkas.php?hal=kegiatan&keg=LDKM"> LDKM</a>
				<a class="btn btn-success" href="peserta_verifikasi_berkas.php?hal=kegiatan&keg=SE"> SE</a>
				...
				<table  class="display table table-bordered table-striped" id="dynamic-table">
					...
					<tbody>
						...
						echo "
							...
							<td>$data->status_berkas</td>              
							<td>$data->keterangan</td>              
							<td class='center hidden-phone'>"; if($data->status_berkas=='Unvalid'){ echo "<a href='peserta_verifikasi_berkas_detail.php?id=$data->id_peserta&kegiatan=$keg'><button class='btn btn-info' type='button'> Unvalid</button></a>";}
							else {echo "<button class='btn btn-info' type='button' disabled> Valid</button>";}
							echo "</td> 								
						</tr>";
						}?>
