...
<head>
  ...
  <title>Latihan Dasar Kepemimpinan Mahasiswa <?php echo "$thn";?></title>
            ...
            <div class="panel-body invoice">
				<div class="row">
                    ...
                    <div class="col-md-10 col-sm-10">
                        <h5 align="right">PANITIA LATIHAN DASAR KEPEMIMPINAN MAHASISWA<?php echo "$thn"; ?><br/>
                ...
                <div class="invoice-address">
                    <div class="row">
                        <div class="col-md-9 col-sm-9">
                            Daftar Peserta Latihan Dasar Kepemimpinan Mahasiswa <?php echo "$thn ($ket)"; ?>
                        </div>
                    </div>
                </div></br>
