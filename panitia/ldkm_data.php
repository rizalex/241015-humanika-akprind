            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li class="menu-list nav-active"><a href="#"><i class="fa fa-clipboard"></i> <span>Daftar Peserta</span></a>
					<ul class="sub-menu-list">
						...
						<li class="active"><a href="ldkm_data.php"> Latihan Dasar Kepemimpinan Mahasiswa</a></li>
					</ul>
				</li>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Tabel Peserta Latihan Dasar Kepemimpinan Mahasiswa</li>
            </ul>
        </div>
        <!-- page heading end-->
            ...
            <ul role="menu" class="dropdown-menu">
                <?php
                    ...
                    foreach (range($currentYear-4, $currentYear+1) as $value)
                        echo "<li><a href='ldkm_data.php?tahun=".$value."'>" . $value . "</a></li>"; ?>
            </ul>
        </div>
		<div class="btn-group">
