            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li class="menu-list nav-active"><a href="#"><i class="fa fa-file"></i> <span>Laporan</span></a>
					<ul class="sub-menu-list">
						...
						<li class="active"><a href="laporan_keuangan_se.php?tahun=<?php echo $thnskrg;?>">Laporan Keuangan Studi Ekskursi</a></li>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Laporan Keuangan Studi Ekskursi <?php echo "$thn"; ?></li>
            </ul>
        </div>
        <!-- page heading end-->
		...
		<div class="btn-group">
            ...
            <ul role="menu" class="dropdown-menu">
                <li><a href="laporan_keuangan_se.php?tahun=2015">2015</a></li>
                <li><a href="laporan_keuangan_se.php?tahun=2016">2016</a></li>
                <li><a href="laporan_keuangan_se.php?tahun=2017">2017</a></li>
            </ul>
        </div>
		
        <a class="btn btn-primary" target="_blank" href="print_se_keuangan.php?tahun=<?php echo "$thn";?>"><i class="fa fa-print"></i> Print </a>
        <div class="panel-body invoice">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-2 ">
                        <h3 align="right">PANITIA STUDI EKSKURSI <?php echo "$thn";?><br/>
                ...
                <div class="invoice-address">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-3">
                            <h1 class="t-due">Laporan Keuangan Studi Ekskursi  <?php echo "$thn"; ?></h1>
                        </div>
                    </div>
                </div></br>
				<div class="adv table">
