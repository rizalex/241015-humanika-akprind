    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
				...
				<li>
                    <a href="ldkm_laporan.php?tahun=<?php echo $thnskrg;?>"> Laporan Peserta LDKM</a>
                </li>
                <li class="active"> Laporan Peserta LDKM Berdasarkan Status Pembayaran</li>
            </ul>
        </div>
        <!-- page heading end-->
        ...
        <a class="btn btn-primary" target="_blank" href="print_ldkm_status.php?tahun=<?php echo "$thn";?>&keterangan=<?php echo "$ket";?>"><i class="fa fa-print"></i> Print </a>
                ...
                <div class="invoice-address">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-3">
                            <h1 class="t-due">Daftar Peserta Latihan Dasar Kepemimpinan Mahasiswa  <?php echo "$thn"; ?> (<?php echo "$ket"; ?>)</h1>
                        </div>
                    </div>
                </div></br>
                <table class="table table-bordered table-invoice">
					...
					<tr>
						...
						<?php
							...
							$hasil = $client->DaftarLDKMStatusTahun($thn, $ket);
