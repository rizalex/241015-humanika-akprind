    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Tabel Peserta Studi Ekskursi <?php echo "$thn";?> (<?php echo "$stat";?>)</li>
            </ul>
        </div>
        <!-- page heading end-->
		...
		<?php
			...
			$hasil = $client->DaftarSEStatusTahun($thn, $stat);
			$no=1;
		?>
        <tbody>
		 <?php
        ...
        <tr class='gradeX'>
			...
			<td>$dat->nama_mhs</td>            	
			<td>$dat->angkatan</td>
			<td><div class='col-md-4'><div class='blog-img-sm'><img src='../file/peserta/foto/$dat->nama_foto' title='$dat->nama_foto'></div></div></td>
