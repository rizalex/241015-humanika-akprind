    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
				...
				<li>
                    <a href="se_data.php"> Tabel Peserta SE Keseluruhan</a>
                </li>
                <li class="active"> Tabel Peserta Studi Ekskursi Status Berkas (<?php echo $stat;?>)</li>
            </ul>
        </div>
        <!-- page heading end-->
		...
		<?php
			...
			$hasil = $client->DaftarSEBerkas($stat);
			$no=1;
			if(empty($thn)){
		?>
		...
		<div class="btn-group">
            ...
            <ul role="menu" class="dropdown-menu">
                <li><a href="se_data_tahun.php?tahun=2015">2015</a></li>
                <li><a href="se_data_tahun.php?tahun=2016">2016</a></li>
                <li><a href="se_data_tahun.php?tahun=2017">2017</a></li>
            </ul>
        </div>
		<div class="btn-group">
            ...
            <ul role="menu" class="dropdown-menu">
                <li><a href="se_data_status.php?stat=Belum Lunas"> Belum Lunas </a></li>
				<li><a href="se_data_status.php?stat=Lunas"> Lunas </a></li>
            </ul>
        </div>
		<div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-info dropdown-toggle" type="button">Status Berkas <span class="caret"></span></button>
            <ul role="menu" class="dropdown-menu">
                <li><a href="se_data_berkas.php?stat=Unvalid"> Unvalid </a></li>
				<li><a href="se_data_berkas.php?stat=Valid"> Valid </a></li>
            </ul>
        </div>
        <div class="adv-table">
        ...
        <tr class='gradeX'>
            ...
            <td class='center hidden-phone'>
				<a href='se_peserta_detail.php?id=$dat->id_peserta'><img src='../images/detail.gif' ></a></td>
        </tr>";
		}?>
        </tbody>
        </table>
		...
		<div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-info dropdown-toggle" type="button">Status Pembayaran <span class="caret"></span></button>
            <ul role="menu" class="dropdown-menu">
				<li><a href="se_data_stat_thn.php?stat=Belum Lunas&tahun=<?php echo "$thn";?>"> Belum Lunas </a></li>
				<li><a href="se_data_stat_thn.php?stat=Lunas&tahun=<?php echo "$thn";?>"> Lunas </a></li>
            </ul>
        </div>
		<div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-info dropdown-toggle" type="button">Status Berkas <span class="caret"></span></button>
            <ul role="menu" class="dropdown-menu">
                <li><a href="se_data_berkas.php?stat=Unvalid&tahun=<?php echo "$thn";?>"> Unvalid </a></li>
				<li><a href="se_data_berkas.php?stat=Valid&tahun=<?php echo "$thn";?>"> Valid </a></li>
            </ul>
        </div>
        <div class="adv-table">
        <table  class="display table table-bordered table-striped" id="dynamic-table">
		...
		<?php
			...
			$hasil = $client->DaftarSEBerkasTahun($thn, $stat);
