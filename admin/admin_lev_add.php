    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Add Admin Level </li>
        ...
        <div class="panel-body">
				...
				if (isset($_POST['submit'])) {
					$level = $_POST['level'];
					$result = $client->TambahLevel($level);
				if ($result > 0) {?>
					<script language="javascript">alert('Success'); document.location.href='admin_lev.php'</script>
			<?php
				} else { echo "Failed"; }
				}
			?>
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="">
			...
			<div class="form-group">
                <label for="level" class="col-sm-2 col-sm-2 control-label">Nama Level</label>
                <div class="col-sm-4">
                   <input type="text"  name="level" id="level" class="form-control" placeholder="Masukkan Nama Level">
                </div>
            </div>
			<div class="form-group">
