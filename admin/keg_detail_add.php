    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Add Detail Kegiatan</li>
        ...
        <div class="panel-body">
				...
				if($awal<=$akhir){		
					$result = $client->TambahDetail($keg, $cost, $nama, $kuota, $tahun, $awal, $akhir, $lok);
					if ($result > 0) {?>
						<script language="javascript">alert('Success'); document.location.href='keg_detail.php'</script>
		...
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="">
			<div class="form-group">
                ...
                <div class="col-sm-4">
				 <select class="form-control m-bot15" name="id_keg" id="id_keg">
					...
					<?php $opsi=$client->DaftarKegjen();
					foreach($opsi as $d) echo "<option value='$d->id_keg'>$d->nama_kegiatan</option>";?>
                  </select>
                </div>
            </div>
			<div class="form-group ">
					...
					<div class="col-md-4">
                      <input type="text"  name="biaya" id="biaya" class="form-control" placeholder="Masukkan Biaya Kegiatan">
                    </div>
            </div>
			<div class="form-group ">
                <label for="name" class="control-label col-lg-2">Penanggung Jawab</label>
				<div class="col-lg-4">
                    <input type="text"  name="name" id="name" class="form-control" placeholder="Masukkan Nama Penanggung Jawab">
                </div>
            </div> 
			<div class="form-group ">
				<label for="kuota" class="control-label col-lg-2">Kuota</label>
                <div class="col-md-4">
                    <input class="form-control " id="kuota" name="kuota" type="text" placeholder="Masukkan Jumlah Kuota" />
                </div>
            </div> 
			<div class="form-group ">
			...
			<div class="form-group ">
                ...
                <div class="col-md-4">
                    <select class="form-control m-bot15" name="tahun"><?php
                        $currentYear = date('Y');
                        foreach (range($currentYear, $currentYear+4) as $value)
			...
			<div class="form-group">
				...
				<div class="col-md-4">
                    <input class="form-control form-control-inline input-medium default-date-picker" readonly="" type="text" id="tglawal" name="tglawal" size="16" type="text" />
                </div>
            </div>
			<div class="form-group">
                <label class="control-label col-lg-2">Tanggal Selesai</label>
				<div class="col-md-4">
                    <input class="form-control form-control-inline input-medium default-date-picker"  readonly="" type="text" id="tglakhir" name="tglakhir"/>
                </div>
            </div>
			<div class="form-group">
