    ...
    <div class="main-content" >
        ...
        <div class="panel-body">
				...
				if (isset($_POST['submit'])) {
					...
					$result = $client->TambahJenis($nama, $ket);
				if ($result > 0) {?>
					<script language="javascript">alert('Success'); document.location.href='keg_jenis.php'</script>
			<?php
				} else { echo "Failed"; }
				}
			?>
		...
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="">
			<div class="form-group">
                ...
                <div class="col-sm-4">
                   <input type="text"  name="name" id="name" class="form-control" placeholder="Masukkan Nama Kegiatan">
                </div>
            </div>
			<div class="form-group">
                <label for="ket" class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                <div class="col-sm-4">
                   <input type="text"  name="ket" id="ket" class="form-control" placeholder="Masukkan Keterangan Kegiatan">
                </div>
            </div>
			<div class="form-group">
