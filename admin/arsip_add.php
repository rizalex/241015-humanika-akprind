...
<section>
    ...
    <div class="main-content" >
		...
		<?php
				...
				if (isset($_POST['submit'])) {
					...
					if (empty($_FILES["nama_file"]["tmp_name"])){
						...
						$result = $client->TambahArsip($id, $desk, $file, $name, $size, $type, $jam, $tgl, $status);
						if ($result > 0) {?>
							<script language="javascript">alert('Success'); document.location.href='arsip.php'</script>
		...
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="" enctype="multipart/form-data">
			...
			<div class="form-group ">
                    <label for="deskripsi" class="control-label col-lg-3">Deskripsi</label>
					<div class="col-lg-8">
			...
			<div class="form-group">
                <label class="control-label col-lg-3">Tanggal & Jam Update</label>
                <div class="col-md-4">
