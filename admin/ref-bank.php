    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Tabel Referensi Bank</li>
            </ul>
        </div>
        <!-- page heading end-->
		...
		<a href="ref_bank_add.php"><button class="btn btn-primary" type="button">Add Referensi Bank +</button></a>
        <div class="adv-table">
        ...
        <tr class='gradeX'>
            ...
            <td class='center hidden-phone'>
				<a href='ref_bank_edit.php?id=$data->no_rekening'><img src='../images/edit.png'></a> || 
				<a href='ref_bank_hapus.php?id=$data->no_rekening'><img src='../images/delete.png'></a></td>
        </tr>";
		}?>
        </tbody>
        </table>
