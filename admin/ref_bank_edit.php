    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Edit Referensi Bank</li>
        ...
        <div class="panel-body">
				...
				if (isset($_POST['submit_edit'])) {
					...
					$namapemilik= $_POST['namapemilik'];		
						...
						$result = $client->EditBank($kode, $id, $norek, $namabank, $namapemilik);
						if ($result > 0) {?>
							<script language="javascript">alert('Edit Success'); document.location.href='ref-bank.php'</script>
							<?php } else { echo "Failed"; }
				}
			
			$tampil = $client->TampilEditBank($kode);
			?>
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="">
			...
			<div class="form-group ">
					...
					<div class="col-md-4">
                      <input type="text"  name="norek" id="norek" class="form-control" value="<?php echo $data->no_rekening ?>">
                    </div>
            </div>
			<div class="form-group ">
			...
			<div class="form-group ">
                ...
                <div class="col-md-4">
                    <input class="form-control " id="namapemilik" name="namapemilik" type="text" value="<?php echo $data->nama_pemilik ?>" />
                </div>			
            </div>
			<div class="form-group">
