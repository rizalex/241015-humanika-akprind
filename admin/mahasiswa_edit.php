    ...
    <div class="main-content" >
        ...
        <div class="panel-body">
				...
				if (isset($_POST['submit_edit'])) {
					...
					$angkatan= $_POST['angkatan'];
						$result = $client->EditMahasiswa($kode, $nim, $nama_mhs, $alamat_asal, $alamat_jogja, $jk, $email, $no_telp, $jurusan, $tempat_lahir, $tgl_lahir, $asal_sekolah, $agama, $goldar, $angkatan);
						if ($result > 0) {?>
							<script language="javascript">alert('Edit Success'); document.location.href='mahasiswa_data.php'</script>
		...
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="">
			...
			<div class="form-group ">
				  ...
				  <div class="col-md-4">
                    <input type="text"  name="nama_mhs" id="nama_mhs" class="form-control" value="<?php echo $data->nama_mhs ?>">
                  </div>
            </div>
			<div class="form-group ">
                  <label for="alamat_asal" class="control-label col-lg-2">Alamat Asal</label>
				  <div class="col-lg-8">
                    <textarea   name="alamat_asal" id="alamat_asal" class="form-control"><?php echo $data->alamat_asal ?></textarea>
                  </div>
            </div>
			<div class="form-group ">
                  <label for="alamat_jogja" class="control-label col-lg-2">Alamat Jogja</label>
				  <div class="col-lg-8">
                    <textarea   name="alamat_jogja" id="alamat_jogja" class="form-control"><?php echo $data->alamat_jogja ?></textarea>
                  </div>
            </div>
			<div class="form-group">
				
                <label class="col-lg-2 control-label">Jenis Kelamin</label>
					<?php if($data->jk=="P"){ echo"
                    <div class='col-md-2 icheck minimal'>
                        <div class='radio single-row'>
                            <input tabindex='2' type='radio'  name='jk' value='L' >
                            <label>Laki-laki</label>
                        </div>                                         
                    </div>
					<div class='col-md-2 icheck minimal'>
                        <div class='radio single-row'>
                            <input tabindex='2' type='radio'  name='jk' value='P' checked>
                ...
                <label class="control-label col-lg-2">Tanggal Lahir</label>
                  <div class="col-md-2 col-xs-11">
				    <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="1990-01-01"  class="input-append date dpYears">
                       <input type="text" readonly="" value="<?php echo $data->tgl_lahir ?>" size="16" class="form-control" name="tgl_lahir">
			...
			<div class="form-group ">
					...
					<div class="col-md-4">
                      <input type="text"  name="asal_sekolah" id="asal_sekolah" class="form-control" value="<?php echo $data->asal_sekolah ?>">
                    </div>
            </div>			
			<div class="form-group ">
			...
			<div class="form-group ">
				...
				<div class="col-lg-1">
					<select class="form-control m-bot15" name="goldar" id="goldar">
                        <option value="<?php echo $data->goldar ?>"><?php echo $data->goldar ?></option>
