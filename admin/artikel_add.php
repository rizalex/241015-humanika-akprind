    ...
    <div class="main-content" >
						...
						$nama_gambar=$_FILES['nama_file']['name'];
							...
							if($jenis_gambar=="image/jpeg" || $jenis_gambar=="image/jpg" || $jenis_gambar=="image/gif" || $jenis_gambar=="image/png"){
								...
								if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
									$result = $client->TambahArtikel($id, $judul, $isi, $gambar, $jenis_gambar, $ukuran, $nama_gambar, $tgl, $jam, $admin, $stat, $ukuran);
									if ($result > 0) {?>
		...
		<form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="" enctype="multipart/form-data">
			<div class="form-group">
                ...
                <div class="col-sm-4">
				 <select class="form-control m-bot15" name="iddetail" id="iddetail">
			...
			<div class="form-group">
                <label for="isiberita" class="control-label col-lg-2">Isi Artikel</label>
					<div class="col-lg-10">
					  <textarea class="form-control " name="isiberita" id="isiberita"></textarea>
            <script>
			...
			<div class="form-group">
                <label class="control-label col-lg-2">Tanggal Artikel</label>
			    <div class="col-md-4">
                    <input class="form-control form-control-inline input-medium default-date-picker" type="text" id="tgl" name="tgl" readonly/>
                </div> 
            </div>
			<div class="form-group">
				<label class="control-label col-lg-2">Jam Artikel</label>
                <div class="col-md-3">
                    <div class="input-group bootstrap-timepicker">
                        <input type="text" class="form-control timepicker-24" name="jam" readonly/>
			...
			<input class="form-control " id="admin" name="admin" type="hidden" value="<?php echo $_SESSION['nm_user'];?>" /> 
			<div class="form-group">
                <label class="col-lg-2 control-label">Status</label>
                <div class="col-sm-9 icheck ">
                <div class="minimal-yellow single-row">
                    <div class="radio ">
                        <input tabindex="3" type="radio"  name="status" id="status" value="0" checked>
                        <label>Publish </label>
                    </div>
                </div>
                <div class="minimal-yellow single-row">
                    <div class="radio ">
                        <input tabindex="3" type="radio"  name="status" id="status" value="1" >
