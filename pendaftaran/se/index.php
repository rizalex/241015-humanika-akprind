  ...
  <nav class=" navbar navbar-default" role="navigation">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-">
                <ul class="nav navbar-nav navbar-right">
					...
					<li><a href="../cara-pembayaran.php?keg=<?php echo $keg?>&tahun=<?php echo $tahun?>"><i class="fa fa-money"></i>  Cara Pembayaran</a></li>
					<li>
						...
						<ul class="dropdown-menu dropdown-menu-usermenu pull-right">
							<li><a href="../data-pribadi.php?id=<?php $_SESSION['id_peserta'];?>"><i class="fa fa-user"></i> Profile</a></li>
							<li><a href="../history.php?id=<?php echo $_SESSION['id_peserta']; ?>&keg=SE&tahun=<?php echo $tahun ?>"><i class="fa fa-money"></i> History Pembayaran</a></li>
  ...
  <!--body wrapper start-->
        ...
        <div class="col-md-4">
							...
							<?php
								...
								foreach ($hasil as $data) {
									if($data->tgl_byr_awal<=$tgl && $data->tgl_byr_akhir>=$tgl){ 
													...
													<a href='konfirmasi_pembayaran.php?keg=SE&nim=".$_SESSION['nim']."&peserta=".$_SESSION['id_peserta']."&tahun=$thn'><button class='btn btn-primary btn-lg' type='button' >KONFIRMASI</button></a>
													</center>";}
													else if($st=='Lunas'){
													echo"	
													<center><h3>".DateToIndo($data->tgl_byr_awal)." - ". DateToIndo($data->tgl_byr_akhir)."</h3>
			...
			<?php 
				...
				$sea = $clientarsip->DaftarArtikelLimit($_SESSION['jenis']);	
        ...
        <div class="col-md-8">
		    <?php
					...
					$artikel = $clientartikel->DaftarArtikelSE();
