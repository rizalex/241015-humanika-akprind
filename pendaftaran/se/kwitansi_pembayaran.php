...
<head>
  ...
  <title>Kwitansi Studi Ekskursi <?php echo $thn?></title>
                ...
                <div class="invoice-address">
                    <div class="row">
                        <div class="col-md-8 col-sm-9">
                            <center>Kwitansi Studi Ekskursi <?php echo $thn?> Mahasiswa Teknik Informatika</br>
				...
				<div class="invoice-address">
                    <div class="row">
                        <div class="col-md-8 col-sm-9">
							...
							NB : Gunakan kwitansi ini sebagai bukti bahwa anda telah melunasi biaya untuk kegiatan Studi Ekskursi tahun <?php echo $thn?>.
