...
<head>
  ...
  <title>Humanika | Pendaftaran LDKM</title>
								...
								<?php
									...
									if(isset ($_POST['submit_daftar'])) {
											...
											if($x==null) {
												...
												<strong>Maaf !</strong> Anda tidak terdaftar sebagai Mahasiswa Teknik Informatika IST AKPRIND Yogyakarta
												</div>";;
											}else {
												$x=$app->Mahasiswa($_POST['nim']);
												if($_POST['nim'] == $x->nim ) {
													...
													?>
														<script language="javascript"> document.location.href='../cek_peserta.php?keg=LDKM&tahun=<?php echo $thn;?>&id=<?php echo $x->nim;?>'</script>
													<?php
												}else {
													echo "gagal";
												}
